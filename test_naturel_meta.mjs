async function testNaturelMetaID() {
    ...
    const phoneId = '1033194656544690'; // FROM META SCREENSHOT
    const to = '573163799745';

    console.log("Testing Naturel with META ID and Token...");
    const response = await fetch(`https://graph.facebook.com/v21.0/${phoneId}/messages`, {
        ...
        body: JSON.stringify({
            ...
            to: to,
            type: 'text',
            text: { body: 'Naturel: Prueba con ID 1033... (Meta)' }
        })
    });
