               ...
               if (msgs.length > 0 && msgs[msgs.length - 1].role === 'user') {
                ...
                setConversationsList(prev => {
                    ...
                    const convObj = {
                        ...
                        bg: 'var(--primary-600)',
                        lastMsg: latest ? latest.content || (latest.type==='image'?'?? Imagen':(latest.type==='audio'?'?? Audio':'Adjunto')) : 'Inici� conversaci�n',
                    ...
                    let convTags = [];
                    if (convObj.needs_human) convTags.push({ label: 'Atenci�n Req.', color: 'var(--accent-red, #ef4444)' });
